...
import { isSunday, getEffectiveDate, getWeekStart, getDayName, getMonthName } from '@/lib/dateUtils';
import { toast } from 'sonner';

export default function ReviewPage() {
  const { saveReview, getCurrentReview } = useHabits();
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-xs">
                The weekly review is available on Sundays to help you reflect on your week and plan ahead.
              </p>
            </div>
          </motion.div>
        </div>
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.1 }}
          className="p-4 rounded-xl bg-accent border border-accent-foreground/10 flex items-start gap-3"
        >
        ...
        >
          {/* What went well */}
          <div className="space-y-2">
            <Label htmlFor="went-well" className="text-base font-medium">
          ...
          {/* What slipped */}
          <div className="space-y-2">
            <Label htmlFor="slipped" className="text-base font-medium">
              🔄 What slipped?
            </Label>
            <Textarea
              id="slipped"
              value={whatSlipped}
              onChange={(e) => {
                setWhatSlipped(e.target.value);
                setIsSaved(false);
              }}
              placeholder="What habits or goals need more attention..."
              className="min-h-[100px] bg-card"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              value={focusNextWeek}
              onChange={(e) => {
                setFocusNextWeek(e.target.value);
                setIsSaved(false);
              }}
              placeholder="What's your main intention for the coming week..."
